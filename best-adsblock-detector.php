...
function enqueue() {
    ...
    wp_enqueue_style( 'myPluginStyle', plugins_url( '/assets/css/style-admin-dialog.css', __FILE__ ) );
    wp_enqueue_script( 'myPluginScript', plugins_url( '/assets/js/main-js.js', __FILE__ ) );
